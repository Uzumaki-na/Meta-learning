...
class MAML(nn.Module):
    ...
    def _inner_loop(self, support_images, support_labels, query_images):
    ...
    def compute_loss(self, support_images, support_labels, query_images, query_labels):
        log_p_y, _ = self._inner_loop(support_images, support_labels, query_images)
